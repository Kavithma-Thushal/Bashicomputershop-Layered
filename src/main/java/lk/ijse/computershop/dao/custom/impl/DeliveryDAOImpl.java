...
public class DeliveryDAOImpl implements DeliveryDAO {
    ...
    public List<Delivery> loadAll() throws SQLException {
        ...
        while (rst.next()){
            Delivery delivery=new Delivery(rst.getString(1),rst.getString(2),rst.getString(3),rst.getString(4),rst.getString(5),rst.getDate(6).toLocalDate());
    ...
    public int save(Delivery d) throws SQLException {
        return SQLUtil.execute("INSERT INTO delivery VALUES(?, ?, ?, ?, ?, ?)",d.getCode(),d.getCustomerId(),d.getEmployeeId(),d.getOrderId(),d.getLocation(),d.getDate());
    }
